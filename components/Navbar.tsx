export default function Navbar() {
  return (
    <nav className="fixed top-0 w-full z-50 bg-slate-950/60 backdrop-blur-md border-b border-white/10 flex justify-between items-center px-6 md:px-12 py-4">
      ...
      >
        <button className="bg-slate-950 border border-primary-container text-primary-container px-6 py-2 font-label-mono text-sm uppercase hover:bg-primary-container hover:text-on-primary-container transition-all duration-300 scale-95 active:opacity-80">
          Get in Touch
        </button>
      </a>
    </nav>
